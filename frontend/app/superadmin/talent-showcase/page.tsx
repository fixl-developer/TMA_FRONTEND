      ...
      <PageSection title="Format and analytics">
        <div className="grid gap-4 lg:grid-cols-3">
          <Card>
            ...
            <CardContent className="flex items-center gap-4 text-sm text-slate-700">
            ...
            <div className="flex items-center gap-2">
              {selectedRows.length > 0 && (
                <Button
                  ...
                  className="h-8 px-3 text-sm bg-rose-50 border-rose-200 text-rose-700 hover:bg-rose-100"
                >
            ...
            {loading ? (
              ...
              <div className="grid gap-3 md:grid-cols-2">
                {filteredPosts.map((post) => (
                  <article
                    key={post._id}
                    className="group relative overflow-hidden rounded-xl border border-slate-200 bg-white p-4 transition-colors"
                  >
                    <div className="relative flex h-full flex-col">
                      <div className="mb-2 flex items-start justify-between gap-2">
                        ...
                        <span
                          className={`shrink-0 rounded-full px-2.5 py-1 text-xs font-semibold uppercase tracking-wide ${statusBadgeClasses[post.status]}`}
                        >
                      ...
                      <div className="mb-2 flex items-center gap-2 text-xs text-slate-600">
                        <span className="inline-flex items-center gap-1 rounded-full bg-slate-100 px-2 py-0.5">
                          {post.type === "VIDEO" ? (
                            <Film className="h-3 w-3 text-cyan-600" />
                          ) : (
                      ...
                      {post.analytics && (
                        <div className="mt-auto flex flex-wrap items-center justify-between gap-2 border-t border-slate-200 pt-2 text-xs text-slate-600">
                      ...
                      <div className="mt-2 flex items-center gap-2 border-t border-slate-200 pt-2">
                        <Button
                          ...
                          className="h-7 px-2 text-xs text-sky-600 hover:bg-sky-50 flex-1"
                        >
