...
function SearchResultsContent() {
  ...
  useEffect(() => {
    ...
    router.replace(`/superadmin/search?${params.toString()}`, { scroll: false })
        ...
        if (entityType === "ALL" || entityType === "CONTENT") {
          ...
          filtered.forEach((c: any) => {
            searchResults.push({
              ...
              url: `/superadmin/talent-showcase`,
...
export default function SearchResultsPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-slate-50 p-6 flex items-center justify-center">Loading...</div>}>
